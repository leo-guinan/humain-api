...
class RendezvousClient:
    ...
    def observation(self, *, rendezvous_id: str, observed_at: str, service_uuid: str, advertisement_commitment: str, rssi_bucket: int | None = None, sample_count: int = 1) -> dict[str, Any]:
        return self._post("/v1/rendezvous/observation", {"rendezvous_id": rendezvous_id, "scanner": "openhome", "observed_at": observed_at, "service_uuid": service_uuid, "advertisement_commitment": advertisement_commitment, "rssi_bucket": rssi_bucket, "sample_count": sample_count})
